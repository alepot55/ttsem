...
| [triton#11730](https://github.com/triton-lang/triton/issues/11730) | 3.8.0 on sm_120: no cluster barrier at the exit of a multi-CTA kernel, sticky `unspecified launch failure` | filed; backport [#11731](https://github.com/triton-lang/triton/pull/11731), skip lifted on `main` in [#11732](https://github.com/triton-lang/triton/pull/11732) | on `main` since [#10656](https://github.com/triton-lang/triton/pull/10656) |
| [triton#11733](https://github.com/triton-lang/triton/issues/11733) | 3.8.0 on sm_120: MN-packed mxfp4 `dot_scaled` returns wrong results; batched scaled dots fail an assert | filed; backport [#11734](https://github.com/triton-lang/triton/pull/11734) | on `main` since [#10726](https://github.com/triton-lang/triton/pull/10726) and [#11262](https://github.com/triton-lang/triton/pull/11262) |
