...
| [triton#11733](https://github.com/triton-lang/triton/issues/11733) | 3.8.0 on sm_120: MN-packed mxfp4 `dot_scaled` returns wrong results; batched scaled dots fail an assert | filed; backport PR to 3.8.x | on `main` since [#10726](https://github.com/triton-lang/triton/pull/10726) and [#11262](https://github.com/triton-lang/triton/pull/11262) |
