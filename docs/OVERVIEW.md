# ttsem, the longer introduction

What the README leaves out: how the semantics is calibrated against the device, how the three
levels work, and where it stops.
