...
# Topologically Sorted Source Nodes: [sum_1, y, mul], Original ATen: [aten.sum, aten.div, aten.mul]
# Source node to ATen node mapping:
#   mul => mul
#   sum_1 => sum_1
#   y => div
# Graph fragment:
#   %arg0_1 : Tensor "f32[3, 64, 64][4096, 64, 1]cuda:0" = PlaceHolder[target=arg0_1]
...
#   %div : Tensor "f32[3, 64, 64][4096, 64, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%arg0_1, %sum_1), kwargs = {})
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_div_mul_sum_0', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 4, 'num_reduction': 0, 'backend_hash': '568339AA377E4FC0C6A5D38B74F02C2CBA1C400D191E4138AF32BAE843721057', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 196608}},
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            triton_poi_fused_div_mul_sum_0.run(arg0_1, buf0, 12288, stream=stream0)
            del arg0_1
        return (buf0, )
